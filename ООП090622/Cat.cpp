...
Cat::Cat(string name1, string color1)
{
	Setname(name1);
	Setcolor(color1);
	Setage(2);
...
Cat::Cat(string name1, string color1, int age1)
{
	Setname(name1);
	Setcolor(color1);
	Setage(age1);
...
Cat::Cat(string name1, string color1, int age1, double weight1)
{
	Setname(name1);
	Setcolor(color1);
	Setage(age1);
...
Cat::Cat(string name1, string color1, int age1, double weight1, bool is_hungry1)
{
	Setname(name1);
	Setcolor(color1);
	Setage(age1);
